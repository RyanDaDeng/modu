    ...
    <div class="container mx-auto px-4 py-6">
      <div class="bg-gray-900/30 backdrop-blur-sm rounded-xl overflow-hidden mb-6 border border-gray-800/50">
        <div class="divide-y divide-gray-700">
          ...
          <!-- Affiliate Program -->
          <router-link to="/affiliate" class="flex items-center justify-between p-4 hover:bg-gray-750 transition-colors cursor-pointer">
            <div class="flex items-center gap-3">
              <div class="p-2 bg-purple-500/20 rounded-lg">
              ...
              <div class="text-white font-medium">推广中心</div>
            </div>
            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
