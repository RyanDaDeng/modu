<template>
  <div class="sm:hidden fixed bottom-0 left-0 right-0 z-40">
    ...
    <div class="relative grid grid-cols-5 h-14">
      ...
      <router-link
        to="/"
        class="group flex flex-col items-center justify-center py-1 transition-all duration-300 relative"
